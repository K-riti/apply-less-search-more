# apply-less-search-more (PWP JobHunt)
...
```bash
git clone https://github.com/<owner>/apply-less-search-more.git && cd apply-less-search-more
...
If you are publishing this under your own account, use these defaults:

- Repository name: `apply-less-search-more`
- Suggested alternative name: `pwp-jobhunt-agent`
- Short description: `AI-assisted personal job search agent for ATS boards with filtering, scoring, digesting, and daily automation.`

After creating the repository on GitHub, set the remote and push:

```bash
git remote set-url origin https://github.com/<your-username>/apply-less-search-more.git
